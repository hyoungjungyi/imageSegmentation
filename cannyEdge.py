...
image = cv2.imread(r"C:\Users\DoyoungJang\Desktop\hjwork\imageComparison\ct_data\10.png", cv2.IMREAD_GRAYSCALE)
image = cv2.resize(image, (321, 600))

image_c = cv2.imread(r"C:\Users\DoyoungJang\Desktop\hjwork\imageComparison\lenna\lenna.png", cv2.IMREAD_COLOR)
